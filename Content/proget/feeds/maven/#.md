...
Maven artifacts may contain vulnerabilities or risky Licenses. These could pose a risk to your organization. When vulnerabilities are present in Maven artifacts, they pose potential risks such as security breaches or compliance violations. Similarly, improper licensing of Maven artifacts can lead to legal ramifications if not managed correctly.

ProGet's Software Composition Analysis allows you to manage vulnerabilities and licenses. We recommend reading our documentation to learn more about [Vulnerability Scanning & Blocking](/docs/proget/sca/vulnerabilities) and [Licensing Detection and Blocking](https://docs.inedo.com/docs/proget/sca/licenses)

### Configuring Policies

ProGet's [Policies & Compliance Rules](https://docs.inedo.com/docs/proget/sca/policies) allow you to set comprehensive policies for managing vulnerabilities and licenses in your Maven artifacts.
