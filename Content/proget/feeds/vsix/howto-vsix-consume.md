...
By using ProGet, teams can take extensions from Microsoft’s public Visual Studio Extension repository, the [Visual Studio Marketplace](https://marketplace.visualstudio.com/), and upload them to ProGet, creating a private extension gallery of curated packages that your team can access. 
